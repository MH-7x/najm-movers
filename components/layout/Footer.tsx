        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <svg
                  className="w-4 h-4 fill-green-400 flex-shrink-0"
                  viewBox="0 0 24 24"
                >
          ...
          {/* Services */}
          <div>
            <h4 className="text-white font-bold text-base mb-4 border-b border-blue-600 pb-2">
              Our Services
            </h4>
