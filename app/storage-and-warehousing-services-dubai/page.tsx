...
export const metadata: Metadata = {
  title:
    "Storage & Warehousing Services Dubai | Secure Storage Solutions | Najm Al Dhahabih",
  description:
...
const storageFaqs = [
  {
    ...
    answer:
      "There's no strict minimum. Whether you need storage for 3 days or 3 years, we can accommodate.",
  },
  {
    question: "Can I access my items while they're in storage?",
    answer:
      "Yes. With advance notice, you can visit the warehouse to access your items.",
  },
  {
    question: "How much does storage cost in Dubai?",
    answer:
      "Rates depend on volume. A few boxes and small items might cost AED 300–500/month. A full apartment's worth of furniture can range from AED 1,000–3,000/month. Contact us for an exact quote.",
  },
  {
    question: "Do you pack items before storing them?",
    answer:
      "Yes. We wrap and protect all items before they go into storage to prevent dust, scratches, and damage.",
  },
];
...
export default function StoragePage() {
  return (
    <>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#666666] text-center mb-12">
            Flexible options for every storage need
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {storageTypes.map((s) => (
              <div
                key={s.title}
                className="bg-gray-50 rounded-xl p-7 border border-gray-100 hover:shadow-md transition-shadow"
              >
                <div className="text-4xl mb-4">{s.icon}</div>
                <div className="flex items-center gap-3 mb-3">
                  <h3 className="text-[#00357A] font-bold text-xl">
                    {s.title}
                  </h3>
                  <span className="bg-[#FF2828] text-white text-xs font-semibold px-2.5 py-1 rounded-full">
                    {s.subtitle}
                  </span>
                </div>
      ...
      <section className="py-16 px-4 bg-[#00357A]">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-3">
            About Our Warehouse Facility
          </h2>
          <p className="text-blue-200 text-center mb-8">
            State-of-the-art storage with maximum security
          </p>
          {/* Warehouse banner */}
          <div className="mb-8 rounded-2xl overflow-hidden aspect-[21/9] bg-white/10 flex flex-col items-center justify-center gap-3 border border-white/20">
            ...
            <p className="text-white/50 text-sm font-medium text-center px-4">
              Our modern Dubai warehouse — 24/7 security, fire safety,
      ...
      <CTASection
        title="Need Storage? Let Us Help."
        subtitle="Call +971-55-4495331 or WhatsApp us with what you need to store. We'll give you a quick quote."
        variant="primary"
      />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              {
                num: "1",
                title: "Tell us what you need stored",
                desc: "Call us with the details — what items, how many, and for how long.",
              },
              {
                num: "2",
                title: "We give you a monthly rate",
                desc: "Storage is priced based on the volume of items. A few boxes and a bed will cost less than a full apartment's worth of furniture.",
              },
              {
                num: "3",
                title: "We pick up your items",
                desc: "Our moving crew comes to your home or office, packs and wraps everything if needed, and transports it to our warehouse.",
              },
              {
                num: "4",
                title: "We store it safely",
                desc: "Your items are placed in a designated area, inventoried, and monitored. 24/7 security cameras keep watch.",
              },
              {
                num: "5",
                title: "We deliver when you're ready",
                desc: "When you need your stuff back, just call. We'll deliver it to your new location, unpack it, and set things up.",
              },
            ].map((step) => (
              <div
                key={step.num}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 rounded-2xl overflow-hidden aspect-[21/9] bg-slate-100 flex flex-col items-center justify-center gap-3 border border-slate-200">
            ...
            <p className="text-slate-400 text-sm font-medium text-center px-4">
              Storage solutions from a few boxes to full apartment contents —
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              {
                type: "Small Storage",
                size: "Few boxes + small items",
                price: "AED 300–500/month",
                examples: "Student belongings, seasonal items, documents",
              },
              {
                type: "Medium Storage",
                size: "Studio / 1BHK contents",
                price: "AED 500–1,000/month",
                examples: "Small apartment furniture, appliances, boxes",
              },
              {
                type: "Large Storage",
                size: "Full apartment / villa",
                price: "AED 1,000–3,000/month",
                examples: "Complete home furniture, entire apartment contents",
              },
            ].map((s) => (
              <div
                key={s.type}
              ...
              >
                ...
                <p className="text-[#FF2828] font-bold text-xl mb-3">
                  {s.price}
                </p>
          ...
          <p className="text-center text-[#666666] text-sm mt-6">
            Prices are estimates. Contact us for an exact quote based on your
            specific items.
          </p>
        </div>
      </section>
      ...
      <QuoteFormSection
        title="Get a Storage Quote Today"
        subtitle="Tell us what you need stored and for how long. We'll give you a competitive monthly rate."
      />
      <CTASection
        title="Ready to Store Your Belongings?"
        subtitle="Call +971-55-4495331 — Secure, clean, accessible storage in Dubai."
        variant="primary"
      />
    </>
  );
