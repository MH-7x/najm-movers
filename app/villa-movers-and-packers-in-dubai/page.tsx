...
const villaFaqs = [
  {
    ...
    answer:
      "Most 3–4 bedroom villa moves are completed within 6–10 hours, including packing, transport, and unpacking. Larger villas with 5+ bedrooms may take a full day.",
  },
  {
    question: "How much does it cost to move a villa in Dubai?",
    answer:
      "Villa moving costs typically start from AED 3,000 for a 3-bedroom and go up to AED 7,000+ for larger villas. The exact price depends on the number of items, distance, and any special requirements. Call us for a free quote.",
  },
  {
    question: "Can you move my garden furniture and outdoor items?",
    answer:
      "Yes. BBQ grills, patio sets, plant pots, kids' play equipment — we move it all.",
  },
  {
    question: "Do you move villas from Dubai to other emirates?",
    answer:
      "Yes. We regularly move villas from Dubai to Abu Dhabi, Sharjah, Al Ain, and all other emirates.",
  },
];
...
const services = [
  {
    ...
    description:
      "Beds, wardrobes, dining tables, shelving units — we take them apart carefully using the right tools. Every screw and bolt gets bagged and labeled so reassembly at the new place is clean and fast.",
  },
  {
    title: "Full Packing Service",
    description:
      "We pack every room from top to bottom. Kitchen items get wrapped individually. Clothes go into wardrobe boxes. Electronics get padded. Fragile items like mirrors, artwork, and glassware get custom wrapping.",
  },
  {
    title: "Heavy Item Handling",
    description:
      "Grand pianos, marble tables, heavy safes, gym equipment — we have the equipment and manpower to handle items that a regular crew can't.",
  },
  {
    title: "Loading and Transport",
    description:
      "Our trucks are clean, covered, and equipped with tie-down straps and padding. Everything is loaded strategically — heavy items at the bottom, fragile items secured on top.",
  },
  {
    title: "Unloading and Setup",
    description:
      "At the new villa, we unload everything, place boxes in the correct rooms, reassemble all furniture, and set things up the way you want them.",
  },
  {
    title: "Cleanup",
    description:
      "We remove all packing materials, cardboard boxes, and tape from both the old and new villa. You don't have to deal with the mess.",
  },
];
...
export default function VillaMoversPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-5">
                {[
                  {
                    title: "Hundreds of villa moves completed",
                    desc: "We've done this hundreds of times. Villa moves aren't new to us. We know the common challenges — narrow villa gates, upper floor balconies, items that don't fit through standard doorways.",
                  },
                  {
                    title: "Right crew size for every villa",
                    desc: "We don't send two guys and hope for the best. Based on the size of your villa, we assign the right number of movers — usually 4 to 8 for a standard 3 to 5 bedroom villa.",
                  },
                  {
                    title: "Proper equipment always on hand",
                    desc: "Trolleys, dollies, moving straps, furniture sliders, and protective blankets. For items that can't go through doors, we have crane service options for upper-floor moves if needed.",
                  },
                  {
                    title: "Your timeline is respected",
                    desc: "Most families want to move in one day. We plan so that packing starts early, the truck is loaded by midday, and you're sleeping in your new villa that same night.",
                  },
                ].map((item) => (
      ...
      <FAQSection
        faqs={villaFaqs}
        title="Common Questions About Villa Moving"
      />
      <QuoteFormSection
        title="Get a Free Villa Moving Quote"
        subtitle="Tell us about your villa and we'll give you an accurate, transparent price within 30 minutes."
      />
      <CTASection
